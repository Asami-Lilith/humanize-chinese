...
Usage:
  python3 scripts/train/train_lr_longform.py
  python3 scripts/train/train_lr_longform.py --n-ai 170 --n-human 170 --c 1.0
"""
...
DEFAULT_OUT = os.path.join(_PARENT_DIR, 'data/lr_coef_longform.json')

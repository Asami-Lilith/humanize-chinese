...
Two operating modes:
  ...
  1. Built-in mini mode (default, no external data needed):
     Uses a compact embedded dictionary (~68K terms from 9 key domains:
     Computer, Civil Engineering, Architecture, Electrical Power,
     Mechanical Engineering, Legal, Mathematics, Chemistry, Environmental).
     Bisect search — no domain scoring.
     ALL terms are protected (no weight filtering in mini mode).
...
# ═══════════════════════════════════════════════════════════════════
#  Built-in Mini Dictionary (~68K terms, 9 key technical domains)
#  All terms included — no weight filtering.
#  Auto-generated by _gen_mini_dict.py
# ═══════════════════════════════════════════════════════════════════

# Auto-generated mini dictionary for built-in protect layer.
# All terms from 11 key domains, no weight filtering.
# 68371 terms
_MINI_TERMS_RAW = """\
一一映射
一丁基氧化锡

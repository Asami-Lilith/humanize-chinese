...
**短样本平均降低 52 分**（学术 -49 / 通用 -57 / 小红书 -51），**1300+ 字长篇 -55 分**（v5 长文本特化）。不用注册、不用付费、不用联网、不需要 API Key。默认改写 10 次取 LR 最优的一版（`--best-of-n 0` 可关，恢复单次 5 秒速度）。

---

## 改写前后对比

### 🎓 学术论文（VERY HIGH → MEDIUM，**降 49 分**）

**改写前** 🔴 100分：
> 随着信息技术的不断发展，人工智能在教育领域的应用正在日益深化，呈现出多维度、全方位的发展态势。本研究旨在探讨人工智能技术在个性化学习中的应用机制及其效果，具有重要的理论意义和实践价值。
>
> 值得注意的是，近年来人工智能赋能教育已成为学界关注的焦点。研究表明，智能化系统通过深度融合大数据分析与机器学习算法，能够全方位地评估学生学习状况，从而实现真正意义上的因材施教。

**改写后** 🟡 51分：
> 现在，人工智能在教育领域的应用正在日益深化，呈现出多个层面、多维度的发展态势。本研究尝试探讨人工智能技术在个性化学习中的应用机制及其效果，具有重要的理论意义和实践价值。
>
> 这几年人工智能赋能教育已成为学界关注的焦点。从已有审视来看，智能化系统通过结合大数据分析与机器学习算法，能够各维度地评估学生学习状况，于是实现真正意义上的因材施教。
